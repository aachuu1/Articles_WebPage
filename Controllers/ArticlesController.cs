...
public class ArticlesController : Controller
{
    ...
    public async Task<IActionResult> Index(int page = 1, CancellationToken cancellationToken = default)
    {
        ...
        {
            var author = a.AuthorId != null ? await _userManager.FindByIdAsync(a.AuthorId) : null;
            viewModels.Add(new ArticleViewModel
            {
                ...
                AuthorId = a.AuthorId ?? "N/A",
                AuthorName = author?.UserName ?? "N/A",
    ...
    public async Task<IActionResult> Details(int? id, CancellationToken cancellationToken)
    {
        ...
        var author = article.AuthorId != null ? await _userManager.FindByIdAsync(article.AuthorId) : null;
